...
const DotField = memo<DotFieldProps>(({
  ...
  sparkle = false,
  waveAmplitude = 0,
  gradientFrom = 'rgba(0, 212, 200, 0.35)', // Adjusted default from purple to brand cyan
  gradientTo = 'rgba(139, 92, 246, 0.15)', // Violet gradient
  glowColor = '#0b1622', // Darker backdrop glow color
  ...rest
}) => {
